...
\citep{anders:23, johnston:24}. We explore the radial evolution of
very massive stars while varying convective boundary mixing and
metallicity with models commonly adopted in rapid binary population
synthesis.
...
\citep[$\sim{}0.335$ pressure scale heights,][]{brott:11} following \cite{claret:18}, corresponding to
\texttt{(f,f\_0)=(0.0415,0.008)}. This relatively ``large
